...
namespace ejercicio3
{
    class Program
    {
        ...
        //32 RAM (3) 	USD 1000 	USD 1400 	USD 2000
            ...
            //la opción de memoria  RAM, y si extiende el disco o no 
            //(ingresa 1 para extender y 0 para no extender) 
            //y calcule y emita por pantalla el monto de la máquina seleccionada.

        // op (procesador) om (memoria) od(disco)
        ...
        float precio = 0;
                ...
                Console.WriteLine("Opcion de Memoria: ");
                memoria = int.Parse(Console.ReadLine());
                Console.WriteLine("Amplia el disco? ");
        ...
        switch(procesador){
            ...
            Console.WriteLine("El precio total de la PC es:  " + precio);
